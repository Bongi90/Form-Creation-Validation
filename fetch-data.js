...
async function fetchUserData() {
    // Define the API URL:
    // Declare a constant apiUrl and assign it the string value 'https://jsonplaceholder.typicode.com/users'.
    ...
    try {
        // In the try block, use the await keyword with the fetch function to asynchronously
        // get data from apiUrl. Store the response in a constant named response.
        ...
        // and set its text content to 'Failed to load user data.',
        ...
        dataContainer.style.color = 'red'; // Make error message stand out
    }
}

// Invoke fetchUserData on DOMContentLoaded:
// Outside fetchUserData, add an event listener to document for the DOMContentLoaded event.
// Set the callback function to invoke fetchUserData. This ensures your data fetching logic
// runs once the HTML document has fully loaded.
